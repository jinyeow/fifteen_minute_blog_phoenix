defmodule FifteenMinuteBlogPhoenix.PostController do
  use FifteenMinuteBlogPhoenix.Web, :controller

  alias FifteenMinuteBlogPhoenix.Post
  alias FifteenMinuteBlogPhoenix.Comment
